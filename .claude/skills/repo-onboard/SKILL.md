...
1. `CLAUDE.md` — operator rules (top), assistant limits, engine firewall.
2. `STATUS.md` — current state / next step. CANONICAL if anything conflicts.
3. `docs/COLD_START_HANDOFF.md` — orientation.
...
- Re-read CLAUDE.md "Operator rules" before any big step. If you catch yourself
